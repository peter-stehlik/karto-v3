...
Route::name('osoba.')->group(function () {
	...
	Route::get('/osoba/pridat', [PersonController::class, 'getNewPerson'])->middleware(['auth'])->name('get-new-person');
    Route::post('/osoba/pridat', [PersonController::class, 'postNewPerson'])->middleware(['auth'])->name('post-new-person');
...
Route::name('print.')->group(function () {
    ...
    Route::post('/print/row', [PrintController::class, 'printRow'])->middleware(['auth'])->name('print-row');
});
