<x-app-layout>
    <h1 class="h3 py-2 border-bottom text-uppercase">Nepotvrdené príjmy <a class="btn btn-sm btn-success" href="{{ route('kartoteka.prijem-get') }}">Pridať nový príjem</a></h1>   
                ...
                <tbody>
                    ...
                    <tr class="@if( $income->sum != $transfers_sum ) bg-notice @endif" data-id="{{ $income->id }}">
                        ...
                        <td class="text-center">
                            <a href="{{ route('kartoteka.nepotvrdeny-prijem-potvrdit', [$income->id]) }}">                            
