		...
		for (let i = 0; i < people.length; i++) {
			let personHtml = `
					<tr>
						...
						<td class="icn-td"><a href="javascript:void(0);" class="view js-add-to-print-row" data-person-id="${people[i].id}" data-person-name="${people[i].name1}" title="Pridať do zoznamu na tlač">
